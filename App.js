...
export default TabNavigator({
    ...
    navigationOptions: ({navigation}) => ({
        tabBarIcon: ({focused, tintColor}) => {
            ...
            if (routeName === 'HJEM') {
                return (focused) ? <Image source={require(`./src/img/home-focused.png`)}/> :
                    <Image source={require(`./src/img/home.png`)}/>;
            } else if (routeName === 'BORGERE') {
                return (focused) ? <Image source={require(`./src/img/contacts-focused.png`)}/> :
                    <Image source={require(`./src/img/contacts.png`)}/>;
            } else if (routeName === 'KALENDAR') {
                return (focused) ? <Image source={require(`./src/img/calendar-focused.png`)}/> :
                    <Image source={require(`./src/img/calendar.png`)}/>;
            } else if (routeName === 'INDBAKKE') {
                return (focused) ? <Image source={require(`./src/img/chat-focused.png`)}/> :
                    <Image source={require(`./src/img/chat.png`)}/>;
            } else if (routeName === 'PROFIL') {
                return (focused) ? <Image source={require(`./src/img/profile-focused.png`)}/> :
